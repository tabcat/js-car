...
export class CarWriter implements BlockWriter {
     ...
     */
    static create(roots: CID[] | CID | void, options?: import("./api.js").CarCodecOptions): WriterChannel;
    /**
     ...
     * `{ writer:CarWriter, out:AsyncIterable<Uint8Array> }`.
     */
    static createAppender(options?: import("./api.js").CarCodecOptions): WriterChannel;
    /**
     ...
     */
    _guard(mutex: Promise<void>): Promise<void>;
    /**
