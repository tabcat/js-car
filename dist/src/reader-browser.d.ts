 ...
 */
export function decodeReaderComplete(reader: BytesReader, options?: import("./api.js").CarCodecOptions): Promise<CarReader>;
/**
...
export class CarReader implements CarReaderIface {
     ...
     * @returns {Promise<CarReader>}
     */
    static fromBytes(bytes: Uint8Array, options?: import("./api.js").CarCodecOptions): Promise<CarReader>;
    /**
     ...
     * @returns {Promise<CarReader>}
     */
    static fromIterable(asyncIterable: AsyncIterable<Uint8Array>, options?: import("./api.js").CarCodecOptions): Promise<CarReader>;
    /**
