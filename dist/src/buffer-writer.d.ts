...
export function createWriter(buffer: ArrayBuffer, options?: {
    ...
    maxAllowedHeaderSize?: number | undefined;
    maxAllowedSectionSize?: number | undefined;
}): Writer;
...
declare class CarBufferWriter implements Writer {
     ...
     */
    constructor(bytes: Uint8Array, headerSize: number, limits: import("./limits.js").CarLimits);
    /** @readonly */
     ...
     */
    readonly limits: import("./limits.js").CarLimits;
    /**
