...
export class CarBlockIterator extends CarIteratorBase implements RootsReader, AsyncIterable<Block> {
     ...
     */
    static fromBytes(bytes: Uint8Array, options?: import("./api.js").CarCodecOptions): Promise<CarBlockIterator>;
    /**
     ...
     * @returns {Promise<CarBlockIterator>}
     */
    static fromIterable(asyncIterable: AsyncIterable<Uint8Array>, options?: import("./api.js").CarCodecOptions): Promise<CarBlockIterator>;
    /**
...
export class CarCIDIterator extends CarIteratorBase implements RootsReader, AsyncIterable<CID> {
     ...
     */
    static fromBytes(bytes: Uint8Array, options?: import("./api.js").CarCodecOptions): Promise<CarCIDIterator>;
    /**
     ...
     * @returns {Promise<CarCIDIterator>}
     */
    static fromIterable(asyncIterable: AsyncIterable<Uint8Array>, options?: import("./api.js").CarCodecOptions): Promise<CarCIDIterator>;
    /**
     * Get the list of roots defined by the CAR referenced by this iterator. May be
     * zero or more `CID`s.
     *
