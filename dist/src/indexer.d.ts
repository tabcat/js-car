...
export class CarIndexer implements RootsReader, AsyncIterable<BlockIndex> {
     ...
     */
    static fromBytes(bytes: Uint8Array, options?: import("./api.js").CarCodecOptions): Promise<CarIndexer>;
    /**
     ...
     * @returns {Promise<CarIndexer>}
     */
    static fromIterable(asyncIterable: AsyncIterable<Uint8Array>, options?: import("./api.js").CarCodecOptions): Promise<CarIndexer>;
    /**
