 ...
 */
export function readHeader(reader: BytesReader, strictVersion?: number, maxAllowedHeaderSize?: number): Promise<CarHeader | CarV2Header>;
/**
 ...
 */
export function readBlockHead(reader: BytesReader, maxAllowedSectionSize?: number): Promise<BlockHeader>;
/**
 ...
 * @returns {CarDecoder}
 */
export function createDecoder(reader: BytesReader, options?: CarCodecOptions): CarDecoder;
/**
